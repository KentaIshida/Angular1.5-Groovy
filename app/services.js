...
angular.module("app.ui.services", []).factory("loggit", [
    ...
    ArtistListingObj.getArtists = function(callback){
      ...
      ref.on("value", function(json) {
        ...
        callback(data);
         ...
         console.log("Firebase Error(artists): " + error.code);
      });
    ...
    AlbumListingObj.getAlbums = function(callback){
      ...
      ref.on("value", function(json) {
        ...
        callback(data);
         ...
         console.log("Firebase Error(albums): " + error.code);
      });
    ...
    GenresListingObj.getGenres = function(callback){
      ...
      ref.on("value", function(json) {
        ...
        callback(data);
         ...
         console.log("Firebase Error(genres): " + error.code);
      });
  ...
  function($http) {
    ...
    PlayListObj.getSongs = function(callback){
      var ref = firebase.database().ref("albumsMusic/");
      ref.on("value", function(json) {
        var data = json.val();
        albums = data;
        ...
        callback(data);
         ...
         console.log("Firebase Error(albumsMusic): " + error.code);
      });
  ...
  function($http) {
    ...
    PlayListObj.getSongs = function(callback){
      var ref = firebase.database().ref("artistsMusic/");
      ref.on("value", function(json) {
        var data = json.val();
        artists = data;
        ...
        callback(data);
         ...
         console.log("Firebase Error(artistsMusic): " + error.code);
      });
